...
This example demonstrates how to deploy a resource group with `ignore_tag_changes = true` so externally-added or externally-modified tags do not trigger infrastructure changes.
